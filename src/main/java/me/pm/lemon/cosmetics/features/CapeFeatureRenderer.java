...
public class CapeFeatureRenderer extends FeatureRenderer<AbstractClientPlayerEntity, PlayerEntityModel<AbstractClientPlayerEntity>> {
    ...
    public void render(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, AbstractClientPlayerEntity abstractClientPlayerEntity, float f, float g, float h, float j, float k, float l) {
        String s1 = abstractClientPlayerEntity.getName().toString();
        String s2 = "https://raw.githubusercontent.com/Li4M4tt8IL/PMHack_Info/master/Capes/"+ s1 +".png";
        String s3 = FilenameUtils.getBaseName(s2);
        Identifier TEXTURE = new Identifier(Main.MOD_ID, "textures/" + s3);
