package me.pm.lemon.gui.bindcommandGui;

import me.pm.lemon.gui.bindcommandGui.elements.Panel;
import net.minecraft.client.gui.screen.Screen;
import net.minecraft.client.util.math.MatrixStack;
import net.minecraft.text.Text;

public class BindCommandScreen extends Screen {
    public BindCommandScreen() {
