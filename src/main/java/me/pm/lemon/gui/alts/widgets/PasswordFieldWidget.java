...
public class PasswordFieldWidget extends AbstractButtonWidget implements Drawable, Element {
    ...
    public PasswordFieldWidget(TextRenderer textRenderer, int x, int y, int width, int height, Text text) {
        this(textRenderer, x, y, width, height, (net.minecraft.client.gui.widget.TextFieldWidget)null, text);
    }

    public PasswordFieldWidget(TextRenderer textRenderer, int x, int y, int width, int height, @Nullable net.minecraft.client.gui.widget.TextFieldWidget copyFrom, Text text) {
    ...
    public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        if (this.isVisible()) {
            ...
            if (!string.isEmpty()) {
                ...
                o = this.textRenderer.drawWithShadow(matrices, (OrderedText)this.renderTextProvider.apply(allStar(string2), this.firstCharacterIndex), (float)m, (float)n, j);
            }
